...
from src.controllers import endereco_controller, solicitacao_controller, usuario_controller, secretaria_controller, servico_controller, funcionario_controller
...
app.include_router(secretaria_controller.router)
