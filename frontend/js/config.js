...
export const RESOURCE_CONFIG = {
  ...
  enderecos: {
    ...
    fields: [
      { name: 'cep', label: 'CEP', type: 'text', required: true, pattern: '[0-9]{5}-?[0-9]{3}', hint: 'Formato: 00000-000' },
      { name: 'estado', label: 'UF', type: 'text', required: true, maxlength: 2, transform: 'uppercase' },
      ...
      { name: 'id_usuario', label: 'ID do usuário', type: 'number', required: true, relation: 'usuarios' }
    ],
  ...
  funcionarios: {
    ...
    fields: [{ name: 'nome', label: 'Nome', type: 'text', required: true }, { name: 'cargo', label: 'Cargo', type: 'text', required: true }, { name: 'telefone', label: 'Telefone', type: 'tel', required: true }, { name: 'email', label: 'E-mail', type: 'email', required: true }, { name: 'id_secretaria', label: 'Secretaria', type: 'number', required: true, relation: 'secretarias' }],
